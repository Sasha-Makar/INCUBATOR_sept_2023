...
document.write('<h2>ADDITIONAL#1</h2>');
// // --створити масив з:
...
// //
// let nums = [1, 2, 3, 4, 5];
// let str = ['js', 'html', 'okten', 'owu', 'ua'];
// let dif = [1, 2, true, 5 > 6, 'qwe'];
//
// for (let num of nums) {
//     console.log(num);
// }
...
// //
// let difArr = [1, 2, 3, 3 > 1, 'qwe', 'str', 'asd', false, true, null, {}];
...
//
// let resultBookGenre = booksArr[0];
// for (let book of booksArr) {
//     if (book.genre.length > resultBookGenre.genre.length) {
//         resultBookGenre = book;
//     }
// }
// console.log(resultBookGenre);
// console.log('*******');
// // - знайти книжку/ки з найдовшою назвою
//
// let result = booksArr[0];
// for (let book of booksArr) {
...
// console.log('*******');
// console.log('*******');
// console.log('*******END ADDITIONAL#1*******');
// document.write('*******END ADDITIONAL#1*******<hr>');
//
// document.write('<br><br><br><hr>');


console.log('ADDITIONAL#2');
document.write('ADDITIONAL#2');
...
for (const list of usersList) {
    document.write(`<div class="user-block">
        <h2>${list.id} - ${list.name} - ${list.username}</h2>
        <h3>${list.email} - ${list.phone}</h3>
        
        <div class="address-block">
            <p>City - ${list.address.city}</p>
            <p>Street - ${list.address.street}</p>
            <p>Suite - ${list.address.suite}</p>
            <p>Zip code - ${list.address.zipcode}</p>
        </div>`)
}
