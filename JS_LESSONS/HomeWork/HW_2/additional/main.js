...
//     Інакше слід вивести на екран повідомлення про те, що це маленький масив, в я
// кому менше 3-х елементів.
...
number === 0 ? console.log('000000'):console.log('more then 0000');
...
// Користувач вводить номер квартири просто в змінні або
// через prompt('') .
